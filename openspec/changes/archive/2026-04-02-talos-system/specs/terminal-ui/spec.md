...
The TUI SHALL display a connection status indicator in the top-right corner showing whether the agent is connected.

#### Scenario: Connected
- **WHEN** the TUI has an active IPC connection to the agent
- **THEN** it displays a green "connected" indicator
